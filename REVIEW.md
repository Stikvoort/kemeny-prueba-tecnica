...
[solved] critico, database/init.sql, L83
...
[solved] critico, seguridad
 los tasks pueden ser eliminados por qualquier usuario que tiene el id del task.
...
medio, backend/cmd/server/main.go, L45
 El Health check debe incluir un check de connecion al database para mostrar un mejor vista del vialidad del servicio.
...
[solved] bajo, frontend/src/types/index.ts, L45, L55
...
[solved] bajo, database/init.sql, L6
 pgcrypto esta incluido pero no esta usado.

bajo, backend/cmd/server/main.go, L80
 no hay Graceful shutdown, seguin el comment.

[solved] bajo, backend/cmd/server/main.go, L37
 El AllowedOrigin por CORS no es configurable por los Environment variables.
